...
if (isset($_POST["regAccount"])) {
	...
	$user = new RegUser();
	$log = $dateStamp . '-> Account Created, Details: user: ' . $username . ' pass:' . $password . ' email: ' . $email . ' first: ' . $firstname . ' last: ' . $lastname . ' age: ' . $age . ' zip ' . $zipcode . ' employment: ' . $employment . ' certification:  ' . $cert . ' date_cert: ' . $date . ' imgLoc: ' . $imgUrl . ' \n';
	error_log($log);
...
if (isset($_POST['regAccountFB'])) {
	...
	$user = new RegUser();
	$log = $dateStamp . '-> Account Created, Details: user: ' . $username . ' pass:' . $password . ' email: ' . $email . ' first: ' . $firstname . ' last: ' . $lastname . ' age: ' . $age . ' zip ' . $zipcode . ' employment: ' . $employment . ' certification:  ' . $cert_body . ' date_cert: ' . $date . ' imgLoc: ' . $imgUrl . ' \n';
	error_log($log);
